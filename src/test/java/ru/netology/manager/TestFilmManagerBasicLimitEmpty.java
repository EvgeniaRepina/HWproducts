...
class TestFilmManagerBasicLimitEmpty {
...
//    assertEquals(expected, actual);
    ...
    void souldAddFilmFifteen() {
        ...
        FilmInformation[] actual = manager.getFilms();
        FilmInformation[] expected = new FilmInformation[]{first, second, third, fourth, fifth, sixth, seventh, eighth,
...
//    assertEquals(expected, actual);
    ...
    void getAlllengthSeveral2() {
        ...
        FilmInformation[] expected = new FilmInformation[]{second, first};
