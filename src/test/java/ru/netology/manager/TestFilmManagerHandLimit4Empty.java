...
class TestFilmManagerHandLimit4Empty {
    private FilmManager manager = new FilmManager(4);
...
//    assertEquals(expected, actual);
    ...
    @Test
    void getLast10lengthOnderLimit1() {
        manager.addFilm(first);
        FilmInformation[] actual = manager.getLastLimit();
...
//    assertEquals(expected, actual);
    ...
    // ___________________zero_______________________
    @Test
...
//    assertEquals(expected, actual);
    ...
    void getLast10lengthLimit() {
        ...
        FilmInformation[] actual = manager.getLastLimit();
        FilmInformation[] expected = new FilmInformation[]{fourth, third, second, first};
...
//    assertEquals(expected, actual); тест упадет т.к. сравниваются массивы, а не их элементы
    ...
    @Test
    void getLast10lengthOverLimit5() {
        manager.addFilm(first);
        manager.addFilm(second);
        manager.addFilm(third);
        manager.addFilm(fourth);
        ...
        FilmInformation[] actual = manager.getLastLimit();
        FilmInformation[] expected = new FilmInformation[]{fifth, fourth, third, second};
...
//    assertEquals(expected, actual); тест упадет т.к. сравниваются массивы, а не их элементы
    ...
    void getLast10lengthOverLimit15() {
        ...
        FilmInformation[] actual = manager.getLastLimit();
        FilmInformation[] expected = new FilmInformation[]{fifteen, fourteen, thirteen, twelve};
